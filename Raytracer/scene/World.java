...
public class World
{
	...
	public World(int width, int height)
	{
		...
		objects.add(new Plane(new Point3D(0.0, -100.0, 0.0), new Color(255.0, 100.0, 255.0), new Vector3D(0.0, 1.0, 0.0), new Reflective(1.0)));
		objects.add(new Plane(new Point3D(0.0, 0.0, 400.0), new Color(255.0, 255.0, 100.0), new Vector3D(0.0, 0.0, -1.0), new Reflective(1.0)));
		//objects.add(new Plane(new Point3D(0.0, 150.0, 0.0), new Color(100.0, 255.0, 255.0), new Vector3D(0.0, -1.0, 0.0), new Reflective(1.0)));
		//objects.add(new Plane(new Point3D(0.0, 0.0, -400.0), new Color(255.0, 255.0, 255.0), new Vector3D(0.0, 0.0, 1.0), new Reflective(1.0)));
		//objects.add(new Plane(new Point3D(400.0, 0.0, 0.0), new Color(50.0, 50.0, 255.0), new Vector3D(-1.0, 0.0, 0.0), new Reflective(1.0)));
		//objects.add(new Plane(new Point3D(-400.0, 0.0, -0.0), new Color(255.0, 0.0, 0.0), new Vector3D(1.0, 0.0, 0.0), new Reflective(1.0)));
