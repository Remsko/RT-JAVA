...
public class World
{
	...
	public World(int width, int height)
	{
		...
		objects.add(new Sphere(new Point3D(-10.0, 0.0, 0.0), new Color(1.0, 0.0, 0.0), 60, new Fresnel(1.0, 1.6)));
		...
		objects.add(new Cylinder(new Point3D(0.0, 0.0, 300.0), new Color(0.3, 1.0, 0.3), 60, new Point3D(0.0, 0.0, 30.0), new None()));
		
		objects.add(new Cone(new Point3D(300.0, 0.0, 0.0), new Color(0.0, 1.0, 1.0), 30, new Point3D(0.0, 10.0, 10.0), new None()));
		objects.add(new Cone(new Point3D(-200.0, -50.0, 100.0), new Color(1.0, 0.5, 1.0), 40, new Point3D(30.0, 0.0, 0.0), new None()));
		...
		lights.add(new PointLight(new Point3D(110.0, 60.0, 10.0), new Color(1.0, 0.0, 1.0), 0.4));
		lights.add(new PointLight(new Point3D(70.0, -70.0, -70.0), new Color(1.0, 1.0, 0.0), 0.5));

		lights.add(new PointLight(new Point3D(300.0, 0.0, -200.0), new Color(0.0, 1.0, 1.0), 0.7));
	}
}