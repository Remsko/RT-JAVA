...
public class World
{
	...
	public World(int width, int height)
	{
		...
		objects.add(new Sphere(new Point3D(-10.0, 0.0, 0.0), new Color(46.0, 148.0, 185.0), 60, new Fresnel(0.7, 1.2)));
		//objects.add(new Torus(new Point3D(100.0, 0.0, 0.0), new Color(1.0, 0.5, 0.2), 100, 30, new None()));
		objects.add(new Sphere(new Point3D(100.0, 50.0, 50.0), new Color(255.0, 253.0, 192.0), 70, new Fresnel(1.0, 2.2)));
		objects.add(new Sphere(new Point3D(200.0, -20.0, 0.0), new Color(240.0, 183.0, 117.0), 50, new Fresnel(1.0, 1.7)));
		...
		lights.add(new PointLight(new Point3D(0.0, 0.0, -100.0), new Color(1.0, 1.0, 1.0), 0.5));
	}
}
